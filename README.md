...
### 1. Run the container to execute the unit tests with coverage
```sh
...
| ----------- | ----------- | ----------- | 
 | /applicant/name-information | First name | 
 | /applicant/name-information | Middle name | 
 | /applicant/name-information | Last name | 
 | /applicant/name-information | Suffix | 
 | /applicant/name-information | Date of birth | 
 ...
 | /military-history/service-periods | Branch of service | Air Force
 ...
 | /military-history/service-periods | Grade, Rate or Rank at end of service period | Sargent First Class
...
| ----------- | ----------- | ----------- | 
| First name | Leave blank | Blocks progress with "Enter a first name with 3 or more characters"
...
| Last name | Leave blank | Blocks progress with "Enter a last name with 3 or more characters"
...
| Date of birth | Leave blank | Blocks progress with "Enter a date"
...
| Date of birth | Enter "January 2, asdf" | Blocks progress with "Enter a date."
...
| Field      | Test case | Expected validation |
| ----------- | ----------- | ----------- | 
| Social Security Number | Leave blank | Blocks progress with "Enter a Social Security number"
| Social Security Number | Enter "123-45-6789" | Blocks progress with "Enter a valid 9 digit SSN (dashes allowed)"
| Social Security Number | Enter "001-01-0001" | Validation passes for this field
| Department of Defense ID number |  Leave blank | Blocks progress with "Enter a DoD ID number"
| Department of Defense ID number |  Enter "12345" | Blocks progress with "Enter a valid 10 digit DoD ID number"
...
| Field      | Test case | Expected validation |
| ----------- | ----------- | ----------- | 
| Phone Number | Enter "234-567" | Blocks progress with "Enter a 10-digit phone number (with or without dashes)"
...
| Field      | Test case | Expected validation |
| ----------- | ----------- | ----------- | 
| Branch of sevice | Leave blank | Blocks progress with "Provide a response"
| Branch of sevice | Select 'Air Force' | Validation passes for this field
| Service start date | Leave blank | Blocks progress with "Enter a Service start date"
| Service start date | Enter "January 2, asdf" | Blocks progress with "Enter a date."
| Service start date | Enter "January 2, 2000" | Validation passes for this field
| Service end date | Leave blank | Blocks progress with "Enter a Service end date"
| Service end date | Enter "January 2, asdf" | Blocks progress with "Enter a date."
| Service end date | Enter "January 2, 1990" | Blocks progress with "Enter a date after Service start date."
| Service end date | Enter "January 2, 2004" | Validation passes for this field
| Duty assignment | Leave blank | Blocks progress with "Provide a response"
| Duty assignment | Enter "test" |  Validation passes for this field
| Major command | Leave blank | Blocks progress with "Provide a response"
| Major command | Enter "test" |  Validation passes for this field
...
| Field      | Test case | Expected validation |
| ----------- | ----------- | ----------- | 
| Choice of wood | Leave unselected | Blocks progress with "Select a type of wood"
| Choice of wood | Select 'Cedar" | Validation passes for this field
| Choice of mount | Leave unselected | Blocks progress with "Select a mounting style for your frame"
...
| Field      | Test case | Expected validation |
| ----------- | ----------- | ----------- | 
| Can you receive a package at this address? | Leave unselected | Blocks progress with "Select whether you can receive a package at this address"
| Can you receive a package at this address? | Select 'Yes, I can' | Validation passes for this field

#### 2.10 Continue to Step 5 and follow the instructions in the "Test case" column, click continue to trigger the "Expected validation":
